...
function xmldb_randomstrayquotes_upgrade($oldversion) {
    ...
    if ($oldversion < 2007040100) {
        ...
        upgrade_mod_savepoint(true, 2007040100, 'randomstrayquotes');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        upgrade_mod_savepoint(true, 2007040101, 'randomstrayquotes');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'randomstrayquotes');
    }
