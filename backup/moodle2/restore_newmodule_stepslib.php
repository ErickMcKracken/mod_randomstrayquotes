 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_randomstrayquotes_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $paths = array();
        $paths[] = new restore_path_element('randomstrayquotes', '/activity/randomstrayquotes');
    ...
    protected function process_newmodule($data) {
        ...
        $newitemid = $DB->insert_record('randomstrayquotes', $data);
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_randomstrayquotes', 'intro', null);
    }
}
